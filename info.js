let info = {
  ...
  education: [
    {
      name: "Instituto Tecnológico Del Estado Bolívar",
      place: "Venezuela, Bolívar",
      date: "MAR, 2015 - JUN, 2018",
      degree: "Técnico Superior Universitario en Informática",
      description: "",
      skills: ["HTML", "CSS", "JavaScript", "SQL Server, MySQL", "PHP", "Soporte IT", "Redes", "Ubuntu"],
    },
  ],
  experience: [
    {
  ...
  skills: [
    {
      title: "Lenguajes",
      info: ["Javascript", "Java", "TypeScript"],
      icon: "fa fa-code",
    },
    {
      title: "Frontend",
  ...
  portfolio: [
    {
      ...
      category: "Web App",
      date: "Ene, 2022",
      github: "https://github.com/josegduarte96/ecommerce",
      visit: "https://sneakers-shop-vue.netlify.app/#/",
      description: " Desafio front end mentor.  ",
    },
    {
      name: "Easy Bank",
      pictures: [
      ...
      category: "Web App",
      date: "Ene, 2022",
      github: "https://github.com/josegduarte96/easybank",
    ...
    },
    {
      ...
      category: "Web App",
      date: "Ene, 2022",
      github: "https://github.com/josegduarte96/AppMaps",
    ...
    },
    {
      ...
      category: "Web App",
      date: "Ago, 2021",
      github: "https://github.com/josegduarte96/daybook",
    ...
    },
    {
      ...
      category: "Web App",
      date: "Sep 2021",
      github: "https://github.com/josegduarte96/todo-list-js",
      visit: "https://josegduarte96.github.io/todo-list-js/",
      description: "Lista de tareas en JS!! &#x1F4D1;",
    },
    {
      name: "BlackJack Game",
      pictures: [
      ...
      description: "Autentico juego famoso conocido como BLACKJACK!! o 21",
    },
    {
      name: "Gif Expert App",
      pictures: [
      ...
      description: "Pequeña app para buscar los gifs mas divertidos de la plataforma Giphy",
    },
    {
      name: "Calculadora",
      pictures: [
      ...
      description: "Una calculadora hecha en JavaScript! &#x1F4DF;",
    },
    {
      name: "PokeCard",
      pictures: [
      ...
      category: "Web App",
      date: "Sep 2021",
      github: "https://github.com/josegduarte96/pokecard",
      visit: "http://pokecard-gray.vercel.app/",
      description: "Carta de pokemones, cada vez que se refresca el navegador trae uno nuevo",
    },
  ],
}
