    ...
    sendEmail() {
      if (!this.email || !this.name || !this.text) {
        ...
        var obj = {
          ...
          from_name: this.name,
          message: `Correo: ${this.email}. Cuerpo del mensaje: ${this.text}`,
          to_name: "Jose Duarte",
        };
        ...
        emailjs
          ...
          .then(
            (result) => {
              this.showSnackbar = true;
              this.snackbarMessage = "Gracias, tu mensaje fue enviado!";
            ...
            (error) => {
              this.showSnackbar = true;
              this.snackbarMessage = "Ocurrio un error, No pudimos enviar el mensaje :(";
              this.snackbarColor = "#64808E";
            }
          );
      }
